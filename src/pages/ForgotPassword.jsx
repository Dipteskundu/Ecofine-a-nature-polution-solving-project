...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-page)] flex items-center justify-center pt-20 p-6 theme-transition">
      <div className="w-full max-w-md bg-[var(--bg-card)] rounded-2xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-[var(--border-color)] bg-[var(--bg-surface)] text-[var(--text-primary)] rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none"
